try {
    function tampilkanSidebar() {
        const sidebar = `
          <div class="w-[181px] hidden lg:block h-[874px] fixed overflow-hidden bg-white">
...
try {
    function tampilkanKomponen() {
        const komponen = `
          <div
          class="flex flex-col mx-auto justify-start items-center w-full left-0 top-0 gap-1.5"
        >
        ...
        const komponenContainer = document.getElementById("navbar-notlogin");
        if (komponenContainer) {
          komponenContainer.innerHTML = komponen;
        }
      }
